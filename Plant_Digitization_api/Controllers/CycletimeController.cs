...
namespace Plant_Digitization_api.Controllers
{
    public class CycleTimeController : ApiController
    {
        ...
        public HttpResponseMessage GetDataGroup(Models.CycleTime_Histogram c)
        {
            ...
            else
            {
                using (SqlConnection con = new SqlConnection(con_string))
                {
                    ...
                    cmd.Parameters.Add("@variant ", SqlDbType.NVarChar, 150).Value = c.Variant;
                    cmd.Parameters.Add("@linecode", SqlDbType.NVarChar, 150).Value = c.Line;
        ...
        [HttpPost]
        [CustomAuthenticationFilter]
        public HttpResponseMessage PercentageWiseCT(Models.CycleTime_Histogram c)
        {
            database_connection d = new database_connection();
            string con_string = d.Getconnectionstring(c.CompanyCode, c.PlantCode, c.Line);
            if (con_string == "0")
            ...
            else
            {
                using (SqlConnection con = new SqlConnection(con_string))
                {
                    con.Open();
                    DataSet ds = new DataSet();
                    SqlCommand cmd = new SqlCommand("PercentageWise_CT_New", con);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.CommandTimeout = 0;
                    cmd.Parameters.Add("@machine", SqlDbType.NVarChar, 150).Value = c.Machine;
                    cmd.Parameters.Add("@variantcode", SqlDbType.NVarChar, 150).Value = c.Variant;
                    cmd.Parameters.Add("@fdate", SqlDbType.NVarChar, 150).Value = c.FDate;
                    cmd.Parameters.Add("@tdate", SqlDbType.NVarChar, 150).Value = c.TDate;
                    cmd.Parameters.Add("@offset", SqlDbType.NVarChar, 150).Value = c.offset;
                    cmd.Parameters.Add("@offsetPer", SqlDbType.NVarChar, 150).Value = c.percentage;
                    cmd.Parameters.Add("@count", SqlDbType.NVarChar, 150).Value = c.Count;
                    cmd.Parameters.Add("@LineCode", SqlDbType.NVarChar, 150).Value = c.Line;
                    cmd.Parameters.Add("@Shift", SqlDbType.NVarChar, 150).Value = c.Shift;
        ...
        [HttpPost]
        [CustomAuthenticationFilter]
        public HttpResponseMessage PercentageWiseCTYearly(Models.CycleTime_Histogram c)
        {
            database_connection d = new database_connection();
            string con_string = d.Getconnectionstring(c.CompanyCode, c.PlantCode, c.Line);
            if (con_string == "0")
            ...
            else
            {
                using (SqlConnection con = new SqlConnection(con_string))
                {
                    con.Open();
                    DataSet ds = new DataSet();
                    SqlCommand cmd = new SqlCommand("PercentageWise_CT_Yearly", con);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.CommandTimeout = 0;
                    cmd.Parameters.Add("@machine", SqlDbType.NVarChar, 150).Value = c.Machine;
                    cmd.Parameters.Add("@variantcode", SqlDbType.NVarChar, 150).Value = c.Variant;
                    cmd.Parameters.Add("@year", SqlDbType.NVarChar, 150).Value = c.Year;
                    cmd.Parameters.Add("@offset", SqlDbType.NVarChar, 150).Value = c.offset;
                    cmd.Parameters.Add("@offsetPer", SqlDbType.NVarChar, 150).Value = c.percentage;
                    cmd.Parameters.Add("@count", SqlDbType.NVarChar, 150).Value = c.Count;
                    cmd.Parameters.Add("@LineCode", SqlDbType.NVarChar, 150).Value = c.Line;
        ...
        [HttpPost]
        [CustomAuthenticationFilter]
        public HttpResponseMessage PercentageWiseCTMonthly(Models.CycleTime_Histogram c)
        {
            database_connection d = new database_connection();
            string con_string = d.Getconnectionstring(c.CompanyCode, c.PlantCode, c.Line);
            if (con_string == "0")
            ...
            else
            {
                using (SqlConnection con = new SqlConnection(con_string))
                {
                    con.Open();
                    DataSet ds = new DataSet();
                    SqlCommand cmd = new SqlCommand("PercentageWise_CT_Monthly", con);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.CommandTimeout = 0;
                    cmd.Parameters.Add("@machine", SqlDbType.NVarChar, 150).Value = c.Machine;
                    cmd.Parameters.Add("@variantcode", SqlDbType.NVarChar, 150).Value = c.Variant;
